...
public class Transaction {
    ...
    public Transaction(int year,int month, int day, String time, String category,
                       String companyName,BigDecimal amount, String location, String paymentMethod){
        this.year=year;
        this.month=month;
        this.day=day;
        this.time=time;
    ...
    public String toString_forPrint(String userID, int[]transactionID) {
        ...
        if(this.category.equals("Education"))
            categoryID=0;
        if(this.category.equals("HealthCare"))
            categoryID=1;
        ...
        //return (Array.getInt(transactionID,0)+","+userID+","+amount_s+","+category+","+year+"-"+month+"-"+day+","+time+","+companyName+","+paymentMethod);
    }
}
